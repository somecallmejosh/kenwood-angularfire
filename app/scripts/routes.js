 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .whenAuthenticated('/shop-admin', {
        templateUrl: 'views/shopadmin.html',
        controller: 'ShopadminCtrl'
      })
      .whenAuthenticated('/schedule-admin', {
        templateUrl: 'views/shcheduleadmin.html',
        controller: 'ShcheduleadminCtrl'
      })
      .whenAuthenticated('/site-admin', {
        templateUrl: 'views/siteadmin.html',
        controller: 'SiteadminCtrl'
      })
      .whenAuthenticated('/image-admin', {
        templateUrl: 'views/imageadmin.html',
        controller: 'ImageadminCtrl'
      })
      .whenAuthenticated('/lesson-admin', {
        templateUrl: 'views/lessonadmin.html',
        controller: 'LessonadminCtrl'
      })
      .whenAuthenticated('/video-admin', {
        templateUrl: 'views/videoadmin.html',
